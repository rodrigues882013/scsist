		...
		<div id="conteudo">
			...
			Gestor seja bem vindo, nessa área voce pode determinar qual tipo de relatório deseja gerar, escolha abaixo o tipo de relatorio que deseja gerar.
						...
						<select id="list">
  							...
  							<option value="5">Usuários cadastrados</option>
						</select>
						<div id="form1" >
							<br>
						...
						<script type="text/javascript">
							$('select').change(function(){
								...
								switch(aux){
									case '1':
										$('#form1').html(" ");
										$('#form1').html("<br>Salas<form action='../../GeraDemonstrativo' method='post'><input type='hidden' name='demo' value='1'><select id='sala' name='sala'><%for (int i=1; i<=7; i++){ %><option value='<%=i%>'>Sala <%=i%></option><%} %></select><br><br><input type='submit' value='Gerar'></form>");
										break;
									...
									case '3':
										$('#form1').html(" ");
										$('#form1').html("<br><form action='../../GeraDemonstrativo' method='post'><input type='hidden' name='demo' value='3'>Data:&nbsp;&nbsp;<input type='date' name='data'><br><br>Sala<br><select id='sala' name='sala'><%for (int i=1; i<=7; i++){ %><option value='<%=i%>'>Sala <%=i%></option><%} %></select><br><br><input type='submit' value='Gerar'></form>");
										break;
										
									case '4':
										var html = "<br><form action='../../GeraDemonstrativo' method='post'><input type='hidden' value='4' id='demo' name='demo'><br>Sala<br><select id='sala' name='sala'><%for (int i=1; i<=7; i++){ %><option value='<%=i%>'>Sala <%=i%></option><%} %></select><br><br><input type='submit' value='Gerar'></form>";
										$('#form1').html(" ");
										$('#form1').html(html);
										break;
									...
									case '5':
										$('#form1').html(" ");
										$('#form1').html("<br><form action='../../GeraDemonstrativo' method='post'><input type='hidden' name='demo' value='5'><input type='submit' value='Gerar'></form>");
										break;
								}
							});
