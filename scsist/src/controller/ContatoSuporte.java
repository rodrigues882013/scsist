...
public class ContatoSuporte extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			email.send();
			//session.setAttribute("aviso", "Mensagem enviada com sucesso, em breve nossa equipe responderá seu chamado");
			String resposta = "Mensagem enviada com sucesso, em breve nossa equipe responderá seu chamado";
